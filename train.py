...
energy_df = pd.read_csv("/content/drive/MyDrive/Backup_Carla_tesi_sorry_bisogno_di_gpu/train_features.csv")
...
if args.do_resid:
    ...
    residuals = pd.read_csv("/content/drive/MyDrive/Backup_Carla_tesi_sorry_bisogno_di_gpu/residuals.csv")
...
if model_type == "lstm_ae" or model_type == "conv_ae":
    ...
    np.save('/content/checkpoints/history_usad_resid.npy', history_to_save) #content/checkpoints er prove su drive
else:
    np.save('/content/history_usad_resid.npy', history)
